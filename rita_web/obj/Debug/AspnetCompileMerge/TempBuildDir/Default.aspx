                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="CustomValidator" 
                                        ...
                                        ValidateEmptyText="true" ForeColor="Red" SetFocusOnError="true"></asp:CustomValidator>
<%--                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label4" runat="server" Text="Address:"></asp:Label></td>
                                <td colspan="3">
                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Address") %>' Width="100%" ValidationGroup="testgroup"></asp:TextBox></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="fvInsterPhone"
                                        ErrorMessage="手機格式不正確" ValidationExpression="((\d{10})|(((\(\d{2}\))|(\d{2}-))?\d{4}(-)?\d{3}(\d)?))" ValidationGroup="testgroup"></asp:RegularExpressionValidator>
